...
let _activeFile = null;          // relpath of currently displayed file
...
function openJavadoc(url) {
  ...
  if (pane.classList.contains('show')) {
    ...
    // Wait until tab is visible before navigating (fragment needs visible iframe)
